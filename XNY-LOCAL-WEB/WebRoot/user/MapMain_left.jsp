		...
		<li id="li03" style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='03' ctype='1'/>"><a href="#" onClick="DoMenu('UserMenu3')">报表统计</a></li>	 
 	 	...
 	 	<li id="li04" style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='04' ctype='1'/>"><a href="#" onClick="DoMenu('UserMenu4')">生产数据</a></li>
			 <ul id="UserMenu4" class="collapsed">
				 <li id="Display0401"><a href="#" onClick="doEnv()"             style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='0501' ctype='1'/>">实时数据</a></li>
	   		 <li id="Display0402"><a href="#" onClick="doHis()"             style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='0502' ctype='1'/>">历史数据</a></li>
				 <li id="Display0403"><a href="#" onClick="doGra()"             style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='0503' ctype='1'/>">数据图表</a></li>
			 </ul>	
   
     <li id="li06" style="display:<Limit:limitValidate userrole='<%=FpList%>' fpid='06' ctype='1'/>"><a href="#" onClick="doAlarm_Info()">告警管理</a></li>
